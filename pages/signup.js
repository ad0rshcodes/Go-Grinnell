...
const Signup = () => {
  ...
  return (
    ...
    <form className={styles.form} onSubmit={handleSubmit}> {/* Add handleSubmit to form submission */}
      <input type="text" placeholder="Name" className={styles.inputField} />
      <input type="email" placeholder="Email" className={styles.inputField} />
      <input type="tel" placeholder="Contact Number" className={styles.inputField} />
      <input type="text" placeholder="Pcard Number" className={styles.inputField} />
    ...
    <p className={styles.signInText}>Already a user? <a href="/signin">Sign In</a></p>
  </div>
  );
};
